...
const AnimatedReview = ({ imgSrc, className, ...props }: AnimatedReviewProps) => {
  const POSSIBLE_ANIMATION_DELAYS = ["0s", "0.1s", "0.2s", "0.3s", "0.4s", "0.5s"]

  const animationDelay = POSSIBLE_ANIMATION_DELAYS[Math.random() * POSSIBLE_ANIMATION_DELAYS.length]
  return (
    <div
